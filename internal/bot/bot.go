...
func (b *Bot) registerCommands() {
	commands := []telebot.Command{
		...
		{Text: "steer", Description: "Add steering to active run"},
		...
		{Text: "roles", Description: "List available roles"},
		{Text: "role", Description: "Show role details"},
		{Text: "role_run", Description: "Run a role job"},
		{Text: "jobs", Description: "List durable jobs"},
		{Text: "job", Description: "Show durable job details"},
		{Text: "job_cancel", Description: "Cancel a durable job"},
		{Text: "skill_suggest", Description: "Draft a skill from a job"},
